...
export const useOrderDetails = () => {
  ...
  if (!contextValue) {
    throw new Error('userOrderDetails must be called from within an OrderDetailsProvider');
  }
  return contextValue;
};
...
export const OrderDetailsProvider = (props) => {
  ...
  // utility function to derive tottals from optionsCounts state value
  const calculateTotal = (optionType) => {
    // get and array of counts for the option type (for example, [1,2])
