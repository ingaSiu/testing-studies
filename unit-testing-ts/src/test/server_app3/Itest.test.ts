...
describe('Server app integration tests', () => {
  ...
  // node-fetch example (using fetch API)
  // This test uses the fetch function directly to make an HTTP POST request to
  //the 'http://localhost:8080/register' endpoint.
  ...
  // HTTP POST request to the registration endpoint.
